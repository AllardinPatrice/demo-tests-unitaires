...
public final class StringUtils {
	 ...
	 * @return distance
	 */
	public static int levenshteinDistance(CharSequence lhs, CharSequence rhs) throws CheckNullException {
		if ((lhs == null) || (rhs == null))
			throw new CheckNullException("Exception car valeur nulle");
